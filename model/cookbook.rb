...
Pour in chicken broth, and season with salt, pepper, and red pepper flakes. Reduce heat to low, cover, and simmer for 45 minutes, or until greens are tender.",ingredients: ["1 tablespoon olive oil","1 large onion, chopped","2 cloves garlic, minced","1 teaspoon pepper"], cooking_time: 120,image_url: "http://www.gloryfoods.com/media/images/Fresh%20Garlic%20Greens.jpg"),
      Recipe.new(id: 4,title: "Cornbread", directions: "N/A",ingredients: [], cooking_time: 60,image_url: "/images/Corn-Bread.jpg"),
      Recipe.new(id: 5,title: "Sauteed Spinach", directions: "N/A",ingredients: [], cooking_time: 60,image_url: "/images/sauteed-spinach-small.jpeg"),
      Recipe.new(id: 6,title: "Butter Pecan Cake", directions: "N/A",ingredients: [], cooking_time: 60,image_url: "/images/butter-pecan-cake.jpeg")
  ]
  end
